/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 97ccee44464546e453a7304a6562c997)
// Runtime types generated with workerd@1.20260911.1 2026-09-12 nodejs_compat
interface __BaseEnv_Env {
	DEV_ROUTER_SECRET: string;
	DEV_ROUTER_DASHBOARD_PASSWORD: string;
	ROUTE: DurableObjectNamespace<import("./src/worker").RouteDurableObject>;
	ROUTER_INDEX: DurableObjectNamespace<import("./src/worker").RouterIndex>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "RouteDurableObject" | "RouterIndex";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEV_ROUTER_SECRET" | "DEV_ROUTER_DASHBOARD_PASSWORD">> {}
}
