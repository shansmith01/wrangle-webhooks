...
test("TunnelConnection.forwardLocal sends the localUrl host when the public Host header differs", async () => {
...
test("GET /ready reports unauthorized when the WebSocket upgrade is 401", async () => {
